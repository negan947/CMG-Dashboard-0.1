...
export function ClientTrendsChart({
  ...
  // Force a minimum size to ensure chart is rendered
  const minHeight = 160;

  return (
    <div className={cn("w-full h-full flex flex-col", className)} style={{ minHeight }}>
      <div className="w-full flex-grow" style={{ minHeight }}>
        {data && data.length > 0 ? (
          <ResponsiveContainer width="99%" height="99%" minHeight={minHeight} debounce={50}>
            <LineChart
              data={data}
