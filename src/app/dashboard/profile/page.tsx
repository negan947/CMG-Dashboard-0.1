  ...
  return (
    <div className="space-y-6 md:space-y-8 relative z-10 py-2">
      <div className={`backdrop-blur-xl ${
        isDark 
          ? "bg-[rgba(20,20,25,0.45)] border-[rgba(60,60,75,0.5)]" 
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        {/* Profile Card */}
        <div className={`rounded-xl border backdrop-blur-lg p-6 shadow-sm ${
          isDark 
            ? "bg-[rgba(28,28,35,0.6)] border-[rgba(60,60,75,0.5)]" 
            : "bg-[rgba(255,255,255,0.55)] border-[rgba(255,255,255,0.6)]"
        }`}>
